...
class _CreateTradeAlertUIState extends State<CreateTradeAlertUI> {
  ...
  TextEditingController openedDescriptionController = TextEditingController();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      controller: openedDescriptionController,
                    ...
                    onPressed: () async {
                      await FirebaseFirestore.instance
                          ...
                          .set(TradeAlert(
                            ...
                            openedAt: Timestamp.fromDate(datetime),
                            closedAt: Timestamp.now(),
                            closedDescription: "",
                            isClosed: false,
                            openedDescription:
                                openedDescriptionController.text.trim(),
                            optionType: "",
                            pnl: 0.00,
                            prices: [],
                            strategy: "",
